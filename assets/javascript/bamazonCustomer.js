      ...
      connection.query(query, { id: choice }, function (err, res) {
        ...
        for (var i = 0; i < res.length; i++) {
          if (answer.stock_quantity <= res[i].stock_quantity) {
            ...
            console.log("Sorry, that's more than we have!");
            ChangeQuantity();
          }
        }
      });
  ...
  inquirer
    ...
    .then(function (answer) {
      if (answer.Buy) {
        ...
        console.log("That's ok! It's a lot of money!"); BuyAnother();
      }
    });
};
  ...
  inquirer
    ...
    .then(function (answer) {
      if (answer.BuyAnother) {
        ...
        console.log("That's ok! See you next time!");
        connection.end();
      }
    });
};
  ...
  inquirer
    ...
    .then(function (answer) {
      if (answer.ChangeQuantity) {
        ...
        console.log("Sorry. Check back next millennium for updated inventory!");
        BuyAnother();
      }
    });
};
